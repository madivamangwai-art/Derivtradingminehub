...
CREATE OR REPLACE VIEW public.kyc_verification AS
  SELECT * FROM public.kyc_verifications;

GRANT SELECT, INSERT ON public.kyc_verification TO authenticated;
GRANT ALL ON public.kyc_verification TO service_role;
